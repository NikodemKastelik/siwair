    ...
    self.$draggable.dragaware($.extend({}, self.options, {
        ...
        dragstart: function(evt) {
            ...
            if (self.options.start) {
                self.options.start.call($this, evt, self);
            }
            $this.trigger('start');
...
function Dragaware(el, options) {
    ...
    $dragaware.on('enable.dragaware', function() {
        options.enable = true;
    });

    $dragaware.on('disable.dragaware', function() {
...
$.fn.draggable = function(options) {
    if (options === 'enable') {
        this.trigger('enable.dragaware');
    }

    else if (options === 'disable') {
        this.trigger('disable.dragaware');
    }
